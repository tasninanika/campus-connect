...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=EB+Garamond:ital,wght@0,800;1,800&display=swap"
        rel="stylesheet">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link
        href="https://fonts.googleapis.com/css2?family=EB+Garamond:ital,wght@0,800;1,800&family=Poppins:wght@400;600&display=swap"
        rel="stylesheet">
    ...
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link
        href="https://fonts.googleapis.com/css2?family=Karla:ital,wght@0,200..800;1,200..800&family=Montserrat:ital,wght@0,600;1,600&display=swap"
        rel="stylesheet">
    <script>
    tailwind.config = {
        theme: {
...
<body class="bg-gray-100 font-family-karla flex">
    <?php 
        $u_email = $_SESSION['email'];
         $query = "SELECT * FROM user INNER JOIN administrator ON user.u_id = administrator.administrator_id WHERE user.email = '$u_email'";
    ...
    <aside class="relative h-screen w-96 hidden sm:block shadow-xl bg-gray-800">
        <div class="p-10 mb-10 border-b border-gray-500">
            <a class="text-white text-base font-bold font-garamond hover:text-gray-300">Welcome,
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <!-- <a href="a_dashboard.php"
                class="flex items-center opacity-75 hover:opacity-100 text-white gap-2.5 py-4 pl-6 nav-item">
                <svg class="fill-current" width="24" height="20" viewBox="0 0 18 18" fill="none"
            ...
            <a href="a_alumnus.php" class="flex items-center text-white gap-2.5 py-4 pl-6 nav-item">
            ...
            <a href="a_students.php"
                class="flex items-center text-white opacity-75 hover:opacity-100 gap-2.5 py-4 pl-6 nav-item">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="none">
                    <path
            ...
            <a href="announcements.php"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="none">
                    <path
                        ...
                        stroke="currentColor" stroke-width="1.5" />
                    <path d="M13.5 11C15.433 11 17 9.433 17 7.5C17 5.567 15.433 4 13.5 4" stroke="currentColor"
            ...
            <a href="a_settings.php"
                class="flex items-center text-white opacity-75 hover:opacity-100 gap-2.5 py-4 pl-6 active-nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="none">
                    <path
    ...
    <div class="w-full flex flex-col h-screen overflow-y-auto">
        ...
        <header class="w-full items-center bg-white py-4 px-6 hidden sm:flex">
            <div class="w-1/2">
                <h1 class="mb-36 lg:mb-0 -ml-10 lg:-ml-0 lg:text-4xl font-garamond flex multicolor-text"><img
                        src="images/logo (2).png" alt="" class="lg:w-14 w-14 -mt-1">Campus Connect</h1>
            </div>
                    ...
                    <div class="col-span-5 xl:col-span-3">
                        <div
                            ...
                            <div class="p-7">
                                ...
                                <?php
                                  ...
                                  <span class='text-white'>Error! New password should be minimum 6 character.</span>
													...
													$result = mysqli_query($db, "SELECT * FROM user WHERE email = '" . $email. "' and password = '" . $password. "' and role='Admin'");
                            ...
                            <span>Warning: Invalid password!</span>
                                ...
                                <form name="passform" autocomplete="off" method="post" action="a_settings.php"
                                    class="mt-6">
                                    <!-- current -->
                                    <div class="mb-6">
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <input
                                            ...
                                            type="password" name="new_password" onblur="checkLength(this)" id='password'
                                    ...
                                    <div class="flex justify-end gap-4">
                                        ...
                                        <button
                                            ...
                                            type="submit" name="update" value="Update" onclick="submitform()">
                                            Update
                                        </button>
                                    </div>
                                </form>
