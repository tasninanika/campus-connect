...
<body class="bg-slate-100 font-family-karla flex" x-data="setup()" :class="{ 'dark': isDark }">
    <aside class="relative h-screen w-[350px] hidden sm:block shadow-xl bg-gray-800">
        ...
        <nav class="text-white text-base  pt-3">
            ...
            <a href="pending_blogs.php" class="flex items-center text-white py-2 px-3 ml-4 mr-4 my-1 active-nav-link gap-2.5">
                ...
                <?php
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                          if (isset($row['blog_created_at']) && !is_null($row['blog_created_at'])) {
                            $posted_date = $row['blog_created_at'];
                                ...
                                <div class="flex-grow flex items-center border-gray-100 dark:border-gray-400 text-sm text-gray-600 dark:text-gray-100 py-4">
                                  <div class="flex-grow flex justify-between items-center">
                                    <div class="self-center">
                                      <h3 class="text-gray-800 hover:text-gray-900 dark:text-gray-50 dark:hover:text-gray-100" style="outline: none;"><span class="font-bold"><?php echo $row['first_name']; ?> <?php echo $row['last_name']; ?></span> has created a <span class="font-bold"><?php echo $row['blog_title']; ?></span> blog post.</h3>
                                      ...
                                      <a class="flex items-center font-medium text-purple-500 hover:text-blue-600 dark:text-purple-400 dark:hover:text-blue-500" style="outline: none;" onclick="document.getElementById('modal_<?php echo $row['id']; ?>').showModal()">
                                        ...
                                        <dialog id="modal_<?php echo $row['id']; ?>" class="modal">
                                            <div class="modal-box dark:bg-gray-800">
                                                ...
                                                <h3 class="text-lg font-bold dark:text-white pb-2">Blog</h3>
                                                <p class="py-1 text-black font-semibold dark:text-white"><?php echo $row['blog_title']; ?></p>
                                          ...
                                          href="approve_blog.php?unblock_id=<?=$row['id']?>">Approve
                                          </a>
                                          <a class="btn flex items-center font-medium text-red-500 hover:text-red-500 dark:text-red-500 dark:hover:text-red-500 gap-1 btn-outline text-xs btn-ghost btn-sm px-5" href="reject_blog.php?id=<?=$row['id']?>" 
