                ...
                <?php
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                          if (isset($row['job_created_at']) && !is_null($row['job_created_at'])) {
                            $posted_date = $row['job_created_at'];
                                    ...
                                    <div class="flex-shrink-0 ml-2 mt-5">
                                      <a class="flex items-center font-medium text-purple-500 hover:text-blue-600 dark:text-purple-400 dark:hover:text-blue-500" style="outline: none;" onclick="document.getElementById('modal_<?php echo $row['id']; ?>').showModal()">
                                        ...
                                        <dialog id="modal_<?php echo $row['id']; ?>" class="modal">
                                          ...
                                          href="approve_job.php?unblock_id=<?=$row['id']?>">Approve
                                          </a>
                                          <a class="btn flex items-center font-medium text-red-500 hover:text-red-500 dark:text-red-500 dark:hover:text-red-500 gap-1 btn-outline text-xs btn-ghost btn-sm px-5" href="reject_job.php?id=<?=$row['id']?>" 
