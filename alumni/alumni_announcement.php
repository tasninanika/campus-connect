...
<body class="bg-gray-100 font-family-karla flex">
    <aside class="relative h-screen w-96 hidden sm:block shadow-xl bg-gray-800">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="alumni_profile.php" class="flex items-center text-white gap-2.5 py-4 pl-6 nav-item">
                <svg
                    class="fill-current"
                    width="18"
                    height="18"
            ...
            <a href="alumni_job.php" class="flex items-center text-white py-4 pl-6 nav-item">
            ...
            <a href="alumni_announcement.php" class="flex items-center text-white py-4 pl-6 active-nav-link">
                <i class="fas fa-solid fa-question mr-3"></i>    
                See Announcement 
            </a> 
            <a href="alumni_resource.php" class="flex items-center text-white py-4 pl-6 nav-item">
                <i class="fas fa-solid fa-question mr-3"></i>    
                Resources
            </a> 
            
            <details class="group">
                <summary class="flex items-center text-white py-4 pl-6 nav-item cursor-pointer">
          ...
          <div class="lg:mx-10 mx-auto max-w-screen-2xl my-5 p-4 md:p-6 2xl:p-10">
            ...
            <li class="border-l-2 border-purple-600">
                ...
                <div class="block p-6 rounded-lg shadow-lg bg-gray-100 max-w-screen ml-6 mb-10">
                    ...
                    <a href="#!" class="font-medium text-purple-600 hover:text-purple-700 focus:text-purple-800 duration-300 transition ease-in-out text-sm">A Get-Together is Coming Up</a>
            ...
            <li class="border-l-2 border-green-600">
                ...
                <div class="block p-6 rounded-lg shadow-lg bg-gray-100 max-w-screen ml-6 mb-10">
                    <div class="flex justify-between mb-4">
                    <a href="#!" class="font-medium text-purple-600 hover:text-purple-700 focus:text-purple-800 duration-300 transition ease-in-out text-sm">News</a>
