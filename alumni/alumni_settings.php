...
<body class="bg-gray-100 font-family-karla flex">
    <aside class="relative h-screen w-96 hidden sm:block shadow-xl bg-gray-800">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <details class="group">
                <summary class="flex items-center text-white opacity-75 hover:opacity-100 py-4 pl-6 active-nav-link cursor-pointer">
                  ...
                  >
                    ...
                    <form action="update_profile.php" method="POST">
                          ...
                          <div class="w-full sm:w-1/2">
                            ...
                            <div class="relative">
                              <input
                                ...
                                name="passing_year"
                                id="passing_year"
                                value="<?php echo $row["passing_year"]; ?>"
                                />                             
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="w-full sm:w-1/2">
                          ...
                          >
                          <input
                              class="w-full rounded-lg border border-stroke bg-gray px-5 pl-4 py-2 font-medium text-black focus:border-gray-800 focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                              type="text"
                              name="contact_number"
                              id="contact_number"
                        ...
                        <div class="mb-6 flex flex-col gap-5 sm:flex-row">
                          <div class="w-full sm:w-1/2">
                            <label class="mb-3 block text-sm font-medium text-black dark:text-white"
                              for="city">City</label>
                              <select id="city" name="city" class="w-full rounded-lg border border-stroke bg-gray px-5 py-2 pl-4   font-medium text-black focus:border-gray-800 focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary">
