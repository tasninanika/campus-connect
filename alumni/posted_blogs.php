...
<body class="bg-gray-100 font-family-karla flex" x-data="setup()" :class="{ 'dark': isDark }">
    <aside class="relative h-screen w-[350px] hidden sm:block shadow-xl bg-gray-800">
        ...
        <nav class="text-white text-base  pt-3">
            ...
            <details class="group relative">
              <summary class="flex items-center justify-between text-white gap-2.5 py-2 px-3 mx-4 my-2 active-nav-link cursor-pointer">
            ...
            <div
              ...
              <nav>
                <ol class="flex items-center gap-2">
                  ...
                  <li class="font-medium text-purple-400">Blog</li>
                </ol>
              </nav>
            </div>
            <!-- Breadcrumb End -->
                              ...
                              <div class="flex-grow flex items-center text-gray-600 dark:text-gray-100">
                                  <div class="flex-grow flex justify-between items-center">
                                      ...
                                      <div class="absolute bottom-4 right-4 flex items-center space-x-4">
                                          <a class="flex items-center font-medium text-purple-500 hover:text-blue-600 dark:text-purple-400 dark:hover:text-blue-500 gap-1" href="#0" style="outline: none;" href="javascript:void(0);" onclick="openModal('<?php echo $blog_id; ?>')">
