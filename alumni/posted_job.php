                              ...
                              <div class="flex-grow flex items-center text-gray-600 dark:text-gray-100">
                                  <div class="flex-grow flex justify-between items-center">
                                      ...
                                      <div class="absolute bottom-4 right-4 flex items-center space-x-4">
                                          <a class="flex items-center font-medium text-purple-500 hover:text-blue-600 dark:text-purple-400 dark:hover:text-blue-500 gap-1" href="#0" style="outline: none;" onclick="my_modal_2.showModal()">
                                          ...
                                          <a class="flex items-center font-medium text-purple-500 hover:text-blue-600 dark:text-purple-400 dark:hover:text-blue-500 gap-1"href="delete_job.php?job_id=<?php echo $job_id; ?>" style="outline: none;">
