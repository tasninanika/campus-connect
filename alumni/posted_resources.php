...
<head>
  ...
  .dark .group:focus .dark\:group-focus\:border-gray-700 {
    color: rgba(55, 65, 81);
  }
          ...
          <div class="lg:mx-10 mx-auto max-w-screen-2xl my-5 p-4 md:p-6 2xl:p-10">
            ...
            // Fetch jobs only for the currently logged-in alumni
                ...
                while ($rows = mysqli_fetch_assoc($query)) {
                              ...
                              <div class="flex-grow flex items-center text-gray-600 dark:text-gray-100">
                                  <div class="flex-grow flex justify-between items-center">
                                      ...
                                      <div class="absolute bottom-4 right-4 flex items-center space-x-4">
                                          <a class="flex items-center font-medium text-purple-500 hover:text-blue-600 dark:text-purple-400 dark:hover:text-blue-500 gap-1" href="#0" style="outline: none;" href="javascript:void(0);" onclick="openModal('<?php echo $resources_id; ?>')">
                                          ...
                                          <!-- modal -->
                                          <dialog id="resourcesModal<?php echo $resources_id; ?>" class="modal">
                                            <div class="modal-box  w-11/12 max-w-5xl dark:bg-gray-800">
                                                <div class="grid grid-cols-1 gap-9">
                                                    ...
                                                    <input type="hidden" name="resources_id" value="<?php echo $resources_id; ?>"> <!-- Pass the resources_id -->
                                                            <!-- first -->
                                                            <div class="mb-6">
                                                            <label
                                                            ...
                                                            >
                                                            <input
                                                                class="w-full rounded-lg border border-stroke bg-gray px-5 py-2 font-medium text-black focus:border-gray-800 focus-visible:outline-none dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:focus:border-gray-700"
                                                                type="text"
                                                                name="title"
                                                                id="title"
                  ...
                  // If no resources exist, display a message
                  ?>
