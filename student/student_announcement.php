...
<body class="bg-slate-100 font-family-karla flex" x-data="setup()" :class="{ 'dark': isDark }">
    <aside class="relative h-screen w-[350px] hidden sm:block shadow-xl bg-gray-800">
        ...
        <nav class="text-white text-base  pt-3">
            ...
            <a href="student_dashboard.php" class="flex items-center text-white gap-2.5 py-2 px-3 ml-4 mr-4 my-1 nav-item">
                <svg
                    class="fill-current"
                    width="18"
                    height="18"
            ...
            <a href="student_announcement.php" class="flex items-center text-white py-2 px-3 ml-4 mr-4 my-1 active-nav-link gap-2.5">
